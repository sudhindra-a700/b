...
<style>
    ...
    /* Hide the label of the toggle modal button */
    div[data-testid="stButton"] > button[kind="primary"] > div > p {
        display: none;
    }
...
if st.button("", key="toggle_modal_btn", help="Hidden button to toggle modal"):
    toggle_create_modal()